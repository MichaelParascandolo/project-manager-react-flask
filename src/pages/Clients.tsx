    ...
    <>
      ...
      <div className="flex justify-center w-full min-h-screen">
        <div className="w-[80%] max-w-[900px] text-center">
          <div className="bg-slate-700 border-2 border-slate-400 shadow-md shadow-slate-800 mt-5 p-4 rounded-xl transition-all duration-300 ease-in-out">
          ...
          <div className="flex justify-center">
            <input
              className="mt-4 rounded-lg border-2 tracking-wider border-slate-400 p-2 bg-slate-700 text-white w-full"
              type={"text"}
            ...
            <button
              ...
              className="border-slate-400 mt-4 ml-2 p-2 rounded-lg h-[45px] border-2 bg-slate-700 text-white hover:bg-blue-500 ease-in-out duration-300 transition-all"
            >
              <CgSearch size={25} />
            </button>
          </div>
